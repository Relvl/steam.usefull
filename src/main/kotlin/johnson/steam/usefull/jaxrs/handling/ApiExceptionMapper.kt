...
class ApiExceptionMapper : ExceptionMapper<ApiException> {
    companion object {
        private val responseCache: MutableMap<Class<IApiError>, Response> = ConcurrentHashMap()

        fun getResponse(exception: ApiException): Response {
        ...
        fun getResponse(exception: IApiError): Response {
    ...
    override fun toResponse(exception: ApiException): Response = getResponse(exception)
}